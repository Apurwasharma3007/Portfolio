...
function Header() {
  ...
  return (
    <header className="container mx-auto md:flex justify-between py-2 max-width bg-white dark:bg-dark-mode">
      <div className="flex justify-between items-center py-2 md:py-10">
        <NavLink to="/">
          {isDarkMode ? (
            <img className="w-14" src={logos.logoLight} alt="logo" style={{ width: "200px", height: "50px" }} />
          ) : (
            <img className="w-14" src={logos.logoDark} alt="logo" style={{ width: "200px", height: "50px" }} />
          )}
        </NavLink>
        ...
        <ul className="flex justify-evenly items-center my-5 md:my-0 md:space-x-5 md:mr-5">
          ...
          <li>
            <button
              ...
              className="p-2 bg-red-500 text-white rounded-full flex items-center justify-center transition duration-300 ease-in-out"
            >
